...
| `conflux-core` | https://github.com/conflux-fans/conflux-skills/tree/main/conflux-core | `npx skills add https://github.com/conflux-fans/conflux-skills --skill conflux-core` | Core Space RPC read/write guidance, `cfx_*` methods, contract calls, transaction debugging, and safe send defaults (preflight estimation, network confirmation, user approval). |
