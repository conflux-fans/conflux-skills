...
| `conflux-rpc` | https://github.com/conflux-fans/conflux-skills/tree/main/conflux-rpc | `npx skills add https://github.com/conflux-fans/conflux-skills --skill conflux-rpc` | Routing Core Space vs eSpace RPC flows, with Core write safety guidance (network confirmation, preflight estimation, and risk checks). |
